...
# пошук властивостей
def find_properties(M1, M2):
    union = union_operation(M1, M2)
    print("Об'єднання відношень M1 та M2")
    print(union)
    print("Перетин відношень M1 та M2")
    intersection = intersection_operation(M1, M2)
    print(intersection)
    print("Доповнення відношення M1")
    addition1 = addition_operation(M1)
    print(addition1)
    print("Доповнення відношення M2")
    addition2 = addition_operation(M2)
    print(addition2)
    print("Відношення байдужості M1")
    indifference1 = indifference(M1)
    print(indifference1)
    print("Відношення байдужості M2")
    indifference2 = indifference(M2)
    print(indifference2)
    print("Композиція відношень M1 та M2")
    composition = composition_operation(M1, M2)
    print(composition)
    print("Альфа-рівень при альфа = 0.5")
    alpha = alpha_level(0.5, M1)
    print(alpha)
    print("Альфа-рівень при альфа = 0.9")
    alpha = alpha_level(0.9, M1)
    print(alpha)
    print("Відношення строгої переваги:")
    RS = assosiate_relation(M1)
    print(RS)
    print("Відношення квазі-еквівалентності:")
    RE = quasi_equialent_relation(M1)
    print(RE)
    print("________________________________")
    print("Властивості відношення М1")
    refl = check_reflection(M1)
    if not refl:
        check_antireflection(M1)
    check_symmetry(M1)
    check_fullness(M1)
    check_transitivity(M1)
    print("________________________________")
    print("Властивості відношення М2")
    refl = check_reflection(M2)
    if not refl:
        check_antireflection(M2)
    check_symmetry(M2)
    check_fullness(M2)
    check_transitivity(M2)
    print("________________________________")
